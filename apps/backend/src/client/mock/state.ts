import { Product, ProductDetail } from "@domain/catalog";
...
const productDetails = toProductDetails(products, [
  // Electronics - Apple
  {
    id: "iphone-15-pro",
    longDescription:
  ...
  // Electronics - Other
  {
    ...
    availability: "in-stock",
    stockQuantity: 15,
    relatedProductIds: ["macbook-pro-16", "gaming-laptop", "sony-camera-a7iv"],
  },
  {
    id: "gaming-laptop",
    longDescription:
  ...
  // Fashion - Other brands
  {
    ...
    availability: "in-stock",
    stockQuantity: 20,
    relatedProductIds: ["leather-boots", "adidas-hoodie", "nike-dri-fit-shirt"],
  },
  {
    id: "leather-boots",
    longDescription:
  ...
  // Sports - Fitness Equipment
  {
    ...
    availability: "in-stock",
    stockQuantity: 12,
    relatedProductIds: ["resistance-bands", "adidas-yoga-mat", "nike-gym-bag"],
  },
  {
    id: "resistance-bands",
    longDescription:
  ...
  // Home & Garden
  {
    ...
    availability: "in-stock",
    stockQuantity: 19,
    relatedProductIds: ["dining-table", "vintage-typewriter", "samsung-tv-65"],
  },
  {
    id: "dining-table",
    longDescription:
...
function toProductDetails(
  products: MockBackendState["products"],
  productDetails: Omit<ProductDetail, keyof Omit<Product, "id">>[]
): MockBackendState["productDetails"] {
  return products.map((p) => {
    const details = productDetails.find((d) => d.id === p.id);

    if (!details) throw new Error(`No details found for product ID ${p.id}`);
